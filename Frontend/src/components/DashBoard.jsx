    ...
    <div className="flex min-h-screen w-full bg-gray-100">
      ...
      <div className="lg:w-3/4 w-full p-4">
        <div className="bg-white shadow-md px-6 py-4 flex justify-between items-center relative">
          <button className="text-gray-900 lg:hidden flex items-center" onClick={() => setIsSidebarOpen(true)}>
            <FaBars size={26} />
          </button>
          <h1 className="text-xl font-semibold">Welcome, {user?.name || "User"}!</h1>
          <div className="relative group">
            <img
              className="w-10 h-10 rounded-full cursor-pointer transition-transform duration-200 hover:scale-105 hover:ring-2 hover:ring-gray-300"
            ...
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg z-50 overflow-hidden opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <button
                className="flex w-full px-4 py-2 text-left hover:bg-red-500 hover:text-white transition"
